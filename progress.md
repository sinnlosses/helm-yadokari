...
## 完了したこと（このセッション: T-058, T-054, T-059, T-060, T-061, T-057, T-055）
...
T-058・T-054・T-059・T-060・T-061・T-057・T-055 は完了。残り2件（すべて `todo`）。`/loop` で依存の解けたものから1件ずつ実行中:

| id    | 内容                                        | difficulty | 依存                      |
| ----- | ------------------------------------------- | ---------- | ------------------------- |
| T-056 | T-055 で決めた仕様の実装                    | sonnet     | -（T-055完了で解消）      |
