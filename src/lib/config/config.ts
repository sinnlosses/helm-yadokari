import type { Config, ConfigRootPath, LocalPath } from "../../types/types.js"
 ...
 */
export function loadConfig(configRootPath: ConfigRootPath, target: ConfigTarget = NO_TARGET): Config {
